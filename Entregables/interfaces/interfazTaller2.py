def main():
    ...
    print("Elige 1 si quieres acceder al punto 'cambiar'")
    print("Elige 2 si quieres acceder al punto 'cambiar'")
    print("Elige 3 si quieres acceder al punto 'cambiar' ")
    print("Elige 4 si quieres acceder al punto ´cambiar'")
    print("Elige 5 si quieres acceder al punto 'cambiar'")
    print("Elige 6 si quieres acceder al punto 'cambiar'")
